                        ...
                        <?php foreach ($riwayat_transaksi as $transaksi): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php elseif ($transaksi['status'] == 'Dibatalkan' || $transaksi['status'] == 'Selesai'): ?>
                                         <form action="../../includes/actions/hapus_transaksi_pelanggan.php" method="POST" onsubmit="return confirm('Anda yakin ingin menghapus riwayat ini?');">
                                            <input type="hidden" name="id_transaksi" value="<?php echo $transaksi['id_transaksi']; ?>">
